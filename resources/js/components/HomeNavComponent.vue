<template>
  ...
  <div class="container-fluid">
    <div style class="card shadow-none sticky-top">
      <nav
        ...
        role="tablist"
      >
        <ul class="nav nav-pills" style="margin:0 auto" role="tablist">
          <li class="nav-item">
            <a
              v-on:click="component='post-component'"
          ...
          <li class="nav-item">
            <a
              v-on:click="component='groups-view-home'"
              class="nav-link"
